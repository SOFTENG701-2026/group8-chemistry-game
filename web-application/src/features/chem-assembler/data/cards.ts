...
export const CARD_DEF: Record<string, CardDef> = {
  ...
  '-CH(CH3)-':  { display: '—CH(CH₃)—',   name: 'methyl branch', family: 'alkyl'    },
  '-CH(OH)-':   { display: '—CH(OH)—',    name: 'hydroxyl branch', family: 'alcohol'  },
  '-CH(Cl)-':   { display: '—CH(Cl)—',    name: 'chloro branch', family: 'halide'   },
  'CH2=':       { display: 'CH₂=',        name: 'methylene',     family: 'alkyl'    },
  '=CH2':       { display: '=CH₂',        name: 'methylene',     family: 'alkyl'    },
  '=CH-':       { display: '=CH—',        name: 'methine',       family: 'alkyl'    },
  '-CH=':       { display: '—CH=',        name: 'methine',       family: 'alkyl'    },
  '-CH=CH-':    { display: '—CH=CH—',     name: 'ethenylene',    family: 'alkyl'    },
  '(CH3)3C-':   { display: '(CH₃)₃C—',    name: 'tert-butyl',    family: 'alkyl'    },
  '-OH':        { display: '—OH',         name: 'hydroxyl',      family: 'alcohol'  },
  'HO-':        { display: 'HO—',         name: 'hydroxyl',      family: 'alcohol'  },
  ...
  'H-COO-':     { display: 'H-COO—',      name: 'formate',       family: 'ester'    },
  '-CONH2':     { display: '—CONH₂',      name: 'amide',         family: 'amide'    },
  '-COCl':      { display: '—COCl',       name: 'acyl chloride', family: 'halide'   },
...
export const FAMILY: Record<FamilyName | 'amide', FamilyStyle> = {
  ...
  amide:    { bg: '#F2D5F8', border: '#D3A4E3', dot: '#A259C3' },
